  ...
  try {
    ...
    if (updateResponse.status === 200) {
      ...
      if (getUserResponse.status === 200) {
        ...
        ).textContent = `${updatedUser.firstName.toLocaleUpperCase(
          "tr-TR"
        )} ${updatedUser.lastName.toLocaleUpperCase("tr-TR")}`;
        ...
        const profilePictureUrl = `http://localhost:5064/uploads/${updatedUser.profilePicture
          .split("/")
          .pop()}`;
